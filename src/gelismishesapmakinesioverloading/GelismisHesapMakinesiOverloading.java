package gelismishesapmakinesioverloading;
import java.util.Scanner;
public class GelismisHesapMakinesiOverloading {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (islem.equals("q")){                
                ...
                if (kacsayi == 2) {
                    System.out.print("1. Syıyı Giriniz:");
                    int a = scanner.nextInt();
                    System.out.print("2. Syıyı Giriniz:");
                    ...
                    System.out.print("2. Syıyı Giriniz:");
                    int b = scanner.nextInt();
                    System.out.print("3. Syıyı Giriniz:");
